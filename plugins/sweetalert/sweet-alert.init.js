    ...
    SweetAlert.prototype.init = function () {
        ...
        $('.del-class').click(function () {
            ...
            Swal.fire({
                ...
                // reverseButtons: true to reverse position of button
            }).then((result) => {
                if (result.value) {
                    Swal.fire({
                        title: 'Deleted!',
                        ...
                        if (result.value) {
                            window.location.href = "../controllers/classescontroller.php?class_id="+ deleteid +"&delete";
                        }
                    })
                } else if (
            ...
            Swal.fire({
                ...
                if (result.value) {
                    Swal.fire({
                        ...
                        if (result.value) {
                            window.location.href = "../controllers/cocurricularcontroller.php?cocurricular_id="+ deleteid +"&delete";
                        }
                    })
                } else if (
                    // Read more about handling dismissals
            ...
            Swal.fire({
                ...
                if (result.value) {
                    Swal.fire({
                        ...
                        if (result.value) {
                            window.location.href = "../controllers/sportcontroller.php?sport_id="+ deleteid +"&delete";
                        }
                    })
                } else if (
                    // Read more about handling dismissals
            ...
            Swal.fire({
                ...
                if (result.value) {
                    Swal.fire({
                        ...
                        if (result.value) {
                            window.location.href = "../controllers/eventcontroller.php?event_id="+ deleteid +"&delete";
                        }
                    })
                } else if (
                    // Read more about handling dismissals
